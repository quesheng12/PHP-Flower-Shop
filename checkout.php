                                        ...
                                        <li>
                                            ...
                                            <ul class="mega-sub-menu">
                                                ...
                                                <li class="mega-dropdown">
                                                    ...
                                                    <ul class="mega-item">
                                                        <li><a href="trading/shop-single.php">Shop Single</a></li>
                                        ...
                                        <ul class="dropdown-menu ">
                                            <li class="product-cart">
                                                <div class="single-cart-box">
                                                    <div class="cart-img">
                                                        <a href="trading/shop-single.php"><img src="assets/images/cart/cart-1.jpg" alt=""></a>
                                                        <span class="pro-quantity">1x</span>
                                                    </div>
                                                    <div class="cart-content">
                                                        <h6 class="title"><a href="trading/shop-single.php">Rock Soapwort</a></h6>
                                                ...
                                                <div class="single-cart-box">
                                                    <div class="cart-img">
                                                        <a href="trading/shop-single.php"><img src="assets/images/cart/cart-2.jpg" alt=""></a>
                                                        <span class="pro-quantity">1x</span>
                                                    </div>
                                                    <div class="cart-content">
                                                        <h6 class="title"><a href="trading/shop-single.php">Rock Soapwort</a></h6>
                                                ...
                                                <div class="single-cart-box">
                                                    <div class="cart-img">
                                                        <a href="trading/shop-single.php"><img src="assets/images/cart/cart-3.jpg" alt=""></a>
                                                        <span class="pro-quantity">1x</span>
                                                    </div>
                                                    <div class="cart-content">
                                                        <h6 class="title"><a href="trading/shop-single.php">Rock Soapwort</a></h6>
