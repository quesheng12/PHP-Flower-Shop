    ...
    js: {
        ...
        plugins: {
            ...
            'bootstrap-tourist-css': {
                base: path.src.jsplugins + 'bootstrap-tourist/',
                src: 'node_modules/bootstrap-tourist/*.css',
                dest: path.src.jsplugins + 'bootstrap-tourist/'
            },
            'bootstrap-tourist-js': {
                base: path.src.jsplugins + 'bootstrap-tourist/',
                src: 'node_modules/bootstrap-tourist/*.js',
                dest: path.src.jsplugins + 'bootstrap-tourist/',
                minTerser: true
            },
            flatpickr: {
