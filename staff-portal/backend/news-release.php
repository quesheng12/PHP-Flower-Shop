...
$sql = "INSERT INTO news (title,content,date,pre_image,excerpt) VALUES ('" . $_POST['title'] . "','"
    . $_POST['content'] . "','" . $now . "','/images/news/" . $id . "/" . $imgname . "','" . $_POST['excerpt'] . "' );";


if ($conn->query($sql) === TRUE) {
    echo "<script>alert('提交成功');location.href='../src/be_pages_blog_post_manage.php';</script>";
} else {
