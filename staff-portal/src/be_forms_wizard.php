...
<div class="content">
    ...
    <div class="row">
        ...
        <div class="col-md-6">
            <!-- Validation Wizard 2 -->
            <div class="js-wizard-validation2 block block block-rounded">
                <!-- Step Tabs -->
                <ul class="nav nav-tabs nav-tabs-alt nav-justified" role="tablist">
                    <li class="nav-item">
...
<!-- Page JS Plugins -->
<?php $dm->get_js('js/plugins/jquery-bootstrap-wizard/bs4/jquery.bootstrap.wizard.min.js'); ?>
...
<!-- Page JS Code -->
<?php $dm->get_js('js/pages/be_forms_wizard.min.js'); ?>
