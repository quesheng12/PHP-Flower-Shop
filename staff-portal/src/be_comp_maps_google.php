...
<div class="bg-body-light">
    <div class="content content-full">
        <div class="d-flex flex-column flex-sm-row justify-content-sm-between align-items-sm-center">
            <h1 class="flex-sm-fill font-size-h2 font-w400 mt-2 mb-0 mb-sm-2">Google Maps</h1>
...
<script src="https://maps.googleapis.com/maps/api/js?key=<?php echo $dm->google_maps_api_key; ?>"></script>
<?php $dm->get_js('js/plugins/gmaps/gmaps.min.js'); ?>

<!-- Page JS Code -->
<?php $dm->get_js('js/pages/be_comp_maps_google.min.js'); ?>
