    ...
    <div class="block block-rounded">
        ...
        <div class="block-content">
            ...
            <div class="row items-push">
                ...
                <div class="col-lg-8">
                    <button type="button" class="btn btn-dark push" onclick="jQuery('#toast-example-1').toast('show');">
                    ...
                    <button type="button" class="btn btn-dark push" onclick="jQuery('#toast-example-2').toast('show');">
