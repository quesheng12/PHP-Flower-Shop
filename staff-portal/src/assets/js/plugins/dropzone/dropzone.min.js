...
var Emitter = function () {
    ...
    function t(e, n) {
        var i, r, o;
        if (_classCallCheck(this, t), (i = _possibleConstructorReturn(this, _getPrototypeOf(t).call(this))).element = e, i.version = t.version, i.defaultOptions.previewTemplate = i.defaultOptions.previewTemplate.replace(/\n*/g, ""), i.clickableElements = [], i.listeners = [], i.files = [], "string" == typeof i.element && (i.element = document.querySelector(i.element)), !i.element || null == i.element.nodeType) throw new Error("Invalid dropzone element.");
        ...
        var a = null != (o = t.optionsForElement(i.element)) ? o : {};
        if (i.options = t.extend({}, i.defaultOptions, a, null != n ? n : {}), i.options.forceFallback || !t.isBrowserSupported()) return _possibleConstructorReturn(i, i.options.fallback.call(_assertThisInitialized(i)));
        ...
        return i.options.acceptedMimeTypes && (i.options.acceptedFiles = i.options.acceptedMimeTypes, delete i.options.acceptedMimeTypes), null != i.options.renameFilename && (i.options.renameFile = function (e) {
            return i.options.renameFilename.call(_assertThisInitialized(i), e.name, e)
        }), i.options.method = i.options.method.toUpperCase(), (r = i.getExistingFallback()) && r.parentNode && r.parentNode.removeChild(r), !1 !== i.options.previewsContainer && (i.options.previewsContainer ? i.previewsContainer = t.getElement(i.options.previewsContainer, "previewsContainer") : i.previewsContainer = i.element), i.options.clickable && (!0 === i.options.clickable ? i.clickableElements = [i.element] : i.clickableElements = t.getElements(i.options.clickable, "clickable")), i.init(), i
    }
    ...
    return _inherits(t, Emitter), _createClass(t, null, [{
        key: "initClass", value: function () {
            this.prototype.Emitter = Emitter, this.prototype.events = ["drop", "dragstart", "dragend", "dragenter", "dragover", "dragleave", "addedfile", "addedfiles", "removedfile", "thumbnail", "error", "errormultiple", "processing", "processingmultiple", "uploadprogress", "totaluploadprogress", "sending", "sendingmultiple", "success", "successmultiple", "canceled", "canceledmultiple", "complete", "completemultiple", "reset", "maxfilesexceeded", "maxfilesreached", "queuecomplete"], this.prototype.defaultOptions = {
                ...
                fallback: function () {
                    ...
                    try {
                        for (var o, a = this.element.getElementsByTagName("div")[Symbol.iterator](); !(n = (o = a.next()).done); n = !0) {
                            var l = o.value;
                            if (/(^| )dz-message($| )/.test(l.className)) {
                                e = l, l.className = "dz-message";
                                break
                            }
                        }
                    } catch (e) {
                ...
                addedfile: function (e) {
                    ...
                    if (this.element === this.previewsContainer && this.element.classList.add("dz-started"), this.previewsContainer) {
                        ...
                        try {
                            for (var a, l = e.previewElement.querySelectorAll("[data-dz-name]")[Symbol.iterator](); !(i = (a = l.next()).done); i = !0) {
                                var s = a.value;
                        ...
                        try {
                            for (var p, h = e.previewElement.querySelectorAll("[data-dz-size]")[Symbol.iterator](); !(u = (p = h.next()).done); u = !0) (s = p.value).innerHTML = this.filesize(e.size)
                        } catch (e) {
                            c = !0, d = e
                        } finally {
                            try {
                ...
                uploadprogress: function (e, t, n) {
                    if (e.previewElement) {
                        var i = !0, r = !1, o = void 0;
                        try {
                            for (var a, l = e.previewElement.querySelectorAll("[data-dz-uploadprogress]")[Symbol.iterator](); !(i = (a = l.next()).done); i = !0) {
                                var s = a.value;
        ...
        key: "init", value: function () {
            ...
            var n = !0, i = !1, r = void 0;
            try {
                for (var o, a = this.events[Symbol.iterator](); !(n = (o = a.next()).done); n = !0) {
                    var l = o.value;
            ...
            return this.listeners = [{
                element: this.element, events: {
                    dragstart: function (t) {
                        ...
                        return t.dataTransfer.dropEffect = "move" === n || "linkMove" === n ? "move" : "copy", s(t), e.emit("dragover", t)
        ...
        key: "_updateMaxFilesReachedClass", value: function () {
            return null != this.options.maxFiles && this.getAcceptedFiles().length >= this.options.maxFiles ? (this.getAcceptedFiles().length === this.options.maxFiles && this.emit("maxfilesreached", this.files), this.element.classList.add("dz-max-Apendix-reached")) : this.element.classList.remove("dz-max-Apendix-reached")
        }
    }, {
        ...
        key: "resizeImage", value: function (e, n, i, r, o) {
            var a = this;
            return this.createThumbnail(e, n, i, r, !0, function (n, i) {
                ...
                return "image/jpeg" !== r && "image/jpg" !== r || (l = ExifRestore.restore(e.dataURL, l)), o(t.dataURItoBlob(l))
            })
        }
    }, {
        ...
        key: "createThumbnailFromUrl", value: function (e, t, n, i, r, o, a) {
            ...
            return a && (s.crossOrigin = a), s.onload = function () {
                var a = function (e) {
                    return e(1)
                };
                return "undefined" != typeof EXIF && null !== EXIF && r && (a = function (e) {
                    ...
                    var a = l.options.resize.call(l, e, t, n, i), u = document.createElement("canvas"),
                        c = u.getContext("2d");
                    ...
                    drawImageIOSFix(c, s, null != a.srcX ? a.srcX : 0, null != a.srcY ? a.srcY : 0, a.srcWidth, a.srcHeight, null != a.trgX ? a.trgX : 0, null != a.trgY ? a.trgY : 0, a.trgWidth, a.trgHeight);
        ...
        key: "processFiles", value: function (e) {
            ...
            try {
                for (var o, a = e[Symbol.iterator](); !(n = (o = a.next()).done); n = !0) {
                    var l = o.value;
                    l.processing = !0, l.status = t.UPLOADING, this.emit("processing", l)
                }
            } catch (e) {
                i = !0, r = e
            } finally {
        ...
        key: "cancelUpload", value: function (e) {
            if (e.status === t.UPLOADING) {
                var n = this._getFilesWithXhr(e.xhr), i = !0, r = !1, o = void 0;
                try {
                    for (var a, l = n[Symbol.iterator](); !(i = (a = l.next()).done); i = !0) {
                        a.value.status = t.CANCELED
                    }
                } catch (e) {
                    r = !0, o = e
                } finally {
                ...
                if (e[0].upload.chunked) {
                    ...
                    var l = function () {
                        ...
                        if (!(i >= o.upload.totalChunkCount)) {
                            0;
                            var r = i * n.options.chunkSize, l = Math.min(r + n.options.chunkSize, o.size), s = {
                                name: n._getParamName(0),
                                data: a.webkitSlice ? a.webkitSlice(r, l) : a.slice(r, l),
                    ...
                    }, n.options.parallelChunkUploads) for (var s = 0; s < o.upload.totalChunkCount; s++) l(); else l()
                } else {
        ...
        key: "_uploadData", value: function (e, n) {
            var i = this, r = new XMLHttpRequest, o = !0, a = !1, l = void 0;
            try {
            ...
            var c = this.resolveOption(this.options.method, e), d = this.resolveOption(this.options.url, e);
            r.open(c, d, !0), r.timeout = this.resolveOption(this.options.timeout, e), r.withCredentials = !!this.options.withCredentials, r.onload = function (t) {
            ...
            var p = {Accept: "application/json", "Cache-Control": "no-cache", "X-Requested-With": "XMLHttpRequest"};
            for (var h in this.options.headers && t.extend(p, this.options.headers), p) {
                var f = p[h];
            ...
            if (this.options.params) {
                ...
                for (var y in "function" == typeof m && (m = m.call(this, e, r, e[0].upload.chunked ? this._getChunk(e[0], r) : null)), m) {
                    var g = m[y];
                    v.append(y, g)
                }
            }
            ...
            try {
                for (var F, z = e[Symbol.iterator](); !(b = (F = z.next()).done); b = !0) {
                    var x = F.value;
                    this.emit("sending", x, r, v)
                }
            } catch (e) {
                k = !0, w = e
            } finally {
            ...
            this.options.uploadMultiple && this.emit("sendingmultiple", e, r, v), this._addFormElementData(v);
        ...
        key: "_finishedUploading", value: function (e, n, i) {
            var r;
        ...
        key: "_handleUploadError", value: function (e, n, i) {
        ...
        key: "_finished", value: function (e, n, i) {
            var r = !0, o = !1, a = void 0;
            try {
                for (var l, s = e[Symbol.iterator](); !(r = (l = s.next()).done); r = !0) {
                    var u = l.value;
                    u.status = t.SUCCESS, this.emit("success", u, n, i), this.emit("complete", u)
                }
            } catch (e) {
                o = !0, a = e
            } finally {
        ...
        key: "_errorProcessing", value: function (e, n, i) {
            var r = !0, o = !1, a = void 0;
            try {
                for (var l, s = e[Symbol.iterator](); !(r = (l = s.next()).done); r = !0) {
                    var u = l.value;
                    u.status = t.ERROR, this.emit("error", u, n, i), this.emit("complete", u)
                }
            } catch (e) {
                o = !0, a = e
            } finally {
...
Dropzone.initClass(), Dropzone.version = "5.7.0", Dropzone.options = {}, Dropzone.optionsForElement = function (e) {
    ...
    return function () {
        ...
        try {
            for (var o, a = e[Symbol.iterator](); !(n = (o = a.next()).done); n = !0) {
                var l = o.value;
                !1 !== Dropzone.optionsForElement(l) ? t.push(new Dropzone(l)) : t.push(void 0)
            }
        } catch (e) {
            i = !0, r = e
        } finally {
    ...
    for (var t = atob(e.split(",")[1]), n = e.split(",")[0].split(":")[1].split(";")[0], i = new ArrayBuffer(t.length), r = new Uint8Array(i), o = 0, a = t.length, l = 0 <= a; l ? o <= a : o >= a; l ? o++ : o--) r[o] = t.charCodeAt(o);
...
var detectVerticalSquash = function (e) {
    ...
    i.drawImage(e, 0, 0);
    for (var r = i.getImageData(1, 0, 1, t).data, o = 0, a = t, l = t; l > o;) {
...
var contentLoaded = function (e, t) {
    var n = !1, i = !0, r = e.document, o = r.documentElement,
        ...
        l = r.addEventListener ? "removeEventListener" : "detachEvent", s = r.addEventListener ? "" : "on",
        u = function i(o) {
            if ("readystatechange" !== o.type || "complete" === r.readyState) return ("load" === o.type ? e : r)[l](s + o.type, i, !1), !n && (n = !0) ? t.call(e, o.type || o) : void 0
        };
    if ("complete" !== r.readyState) {
        ...
        return r[a](s + "DOMContentLoaded", u, !1), r[a](s + "readystatechange", u, !1), e[a](s + "load", u, !1)
    }
};
