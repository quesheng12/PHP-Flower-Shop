...
<div class="bg-body-light">
    <div class="content content-full">
        <div class="d-flex flex-column flex-sm-row justify-content-sm-between align-items-sm-center">
            <h1 class="flex-sm-fill font-size-h2 font-w400 mt-2 mb-0 mb-sm-2">Timeline</h1>
...
<div class="content">
    ...
    <ul class="timeline timeline-centered timeline-alt">
        ...
        <li class="timeline-event">
            ...
            <div class="timeline-event-block block block-rounded invisible" data-toggle="appear">
            ...
            <div class="timeline-event-block block block-rounded invisible" data-toggle="appear">
                ...
                <div class="block-content">
                    <div class="media font-size-sm push">
                        ...
                        <div class="media-body">
                            <p>
                                You have a meal meeting scheduled with <a class="font-w600" href="javascript:void(0)"><?php echo $dm->get_name('male'); ?></a> today at 16:18.
                            </p>
                        </div>
                    </div>
                </div>
