...
<div class="bg-body-light">
    <div class="content content-full">
        <div class="d-flex flex-column flex-sm-row justify-content-sm-between align-items-sm-center">
            <h1 class="flex-sm-fill font-size-h2 font-w400 mt-2 mb-0 mb-sm-2">Typography</h1>
                ...
                <div class="col-lg-4">
                    ...
                    <ul class="fa-ul list-icons">
                        <li>
                            ...
                            <div class="font-w600">Project</div>
                        ...
                        <li>
                            ...
                            <div class="font-w600">Deadline</div>
                ...
                <div class="col-lg-4">
                    ...
                    <ul class="fa-ul list-icons">
                        <li>
                            ...
                            <div class="font-w600">Location</div>
                        ...
                        <li>
                            ...
                            <div class="font-w600">Rent Per Month</div>
                        ...
                        <li>
                            ...
                            <div class="font-w600">Last Updated</div>
                ...
                <div class="col-lg-4">
                    ...
                    <ul class="fa-ul list-icons">
                        <li>
                            ...
                            <div class="font-w600">Basket</div>
                        ...
                        <li>
                            ...
                            <div class="font-w600">Discount</div>
                        ...
                        <li>
                            ...
                            <div class="font-w600">Created</div>
            ...
            <div class="block block-rounded">
                ...
                <div class="block-content">
                    <blockquote class="blockquote">
                        <p class="mb-0">There is nothing permanent except change.</p>
                        <footer class="blockquote-footer">Heraclitus</footer>
                    </blockquote>
                    <blockquote class="blockquote text-right">
                        <p class="mb-0">If you cannot do great things, do small things in a great way.</p>
                        <footer class="blockquote-footer">Napoleon Hill</footer>
                    </blockquote>
                </div>
            </div>
            <!-- END Blockquotes -->
