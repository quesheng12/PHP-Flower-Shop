...
<div class="content">
    ...
    <div class="row row-deck">
        ...
        <div class="col-6">
            <a class="block block-rounded block-link-shadow text-center" href="javascript:void(0)">
                <div class="block-content py-5">
                    <div class="font-size-h3 font-w600 text-danger mb-1">
        ...
        <div class="block-content bg-body-light text-center">
            <div class="row items-push text-uppercase">
                ...
                <div class="col-6 col-md-3">
                    ...
                    <a class="link-fx font-size-h3" href="javascript:void(0)">$5.680,00</a>
                </div>
                <div class="col-6 col-md-3">
                    <div class="font-w600 text-dark mb-1">Cart</div>
                    <a class="link-fx font-size-h3" href="javascript:void(0)">4</a>
                </div>
                <div class="col-6 col-md-3">
