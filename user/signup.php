    ...
    <div class="col-md-10 m-auto">
        <div class="col-md-8 col-sm-12">
            <form id="form1" class="form1" method="post">
                ...
                <p class="p"><strong>Already have a account? </strong><a href="login.php">Login in</a></p>
                <input type="text" class="input" name="username" placeholder="Username"><br>
                <input type="password" id="p1" class="input" name="password" placeholder="Password"><br>
                <input type="password" id="p2" class="input" placeholder="Confirm Password"><br>
