                    ...
                    <div class="row align-items-center">
                        <div class="col-lg-2">
                            <div class="header-logo">
                                <a href="index.html"><img src="../../kugu-asset/images/logo/logo.png" alt=""></a>
                            </div>
                        </div>
                                            ...
                                            <ul class="mega-sub-menu">
                                                <li class="mega-dropdown">
                                                    ...
                                                    <ul class="mega-item">
                                                        ...
                                                        <li><a href="shop-list.html">物品清单</a></li>
                                                ...
                                                <li class="mega-dropdown">
                                                    ...
                                                    <ul class="mega-item">
                                                        ...
                                                        <li><a href="empty-cart.html">购物车</a></li>
                                                        <li><a href="my-account.html">我的账户</a></li>
                                                    </ul>
                                                </li>
                                                <li class="mega-dropdown">
                                                    <a class="menu-banner" href="#">
                                                        <img src="../../kugu-asset/images/menu-banner.jpg" alt="">
                                                    </a>
                                                </li>
                                            </ul>
                                        </li>
                ...
                <div class="col-xl-3 col-md-4">
                    <div class="my-account-menu mt-30">
                        <ul class="nav account-menu-list flex-column">
                            ...
                            <li>
                                <a data-toggle="pill" href="#pills-edit-account"><i class="fa fa-user"></i> 修改地址</a>
                            </li>
                            <li>
                                <a href="login.html"><i class="fa fa-sign-out"></i>注销</a>
                            </li>
                        </ul>
                    </div>
                </div>
                    ...
                    <div class="tab-content my-account-tab mt-30" id="pills-tabContent">
                        ...
                        <div class="tab-pane fade" id="pills-address">
                            <div class="my-account-address account-wrapper">
                                <div class="row">
                                    <div class="col-md-6">
                                        <h4 class="account-title">账单地址</h4>
                                        <div class="account-address mt-30">
                                            ...
                                            <a class="btn btn-primary" href="#"><i class="fa fa-edit"></i> 修改地址</a>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <h4 class="account-title">配送地址</h4>
                                        <div class="account-address mt-30">
                                            <h6 class="name">Alex Tuntuni</h6>
                                            <p>1355 Market St, Suite 900 <br> San Francisco, CA 94103</p>
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="single-form">
                                                    <input type="text" name="first_name" placeholder="姓氏">
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="single-form">
                                                    <input type="text" name="last_name" placeholder="名字">
                                                </div>
                                            </div>
                                            <div class="col-md-12">
                                                <div class="single-form">
                        ...
                        <div class="footer-widget">
                            ...
                            <div class="footer-widget-menu">
                                <ul>
                                    <li><a href="#">检索词</a></li>
                                    <li><a href="#">高级搜索</a></li>
                                    <li><a href="#">帮助及常见问题</a></li>
                                    <li><a href="#">商店位置</a></li>
                                    <li><a href="#">订单及退货</a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
