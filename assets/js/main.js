(function ($) {
    ...
    function sticky() {
        $(window).on('scroll', function (event) {
            ...
            if (scroll < 350) {
                $("#head-fill").css("height", "0px");
                $("#head-fill").css("padding", "0 0");
                $(".header-section, .header-mobile").removeClass("sticky");
            } else {
                $("#head-fill").css("height", $(".header-section, .header-mobile").css('height'));
                $("#head-fill").css("padding", $(".header-section, .header-mobile").css('padding'));
